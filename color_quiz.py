...
class color(Frame):
    ...
    def create_widgets(self):
        Label(self, text = "Which Color Represents Your Personality?").grid(row = 0, column = 2, columnspan = 2)
        ...
        for word in desserts:
            Radiobutton(self, text=word, variable=self.dessert, value=word).grid(row=2, column=column, padx = 50, sticky=W)
            column += 1
        ...
        column = 0
        for word in jobs:
            Radiobutton(self, text=word, variable=self.job, value=word).grid(row=4, column=column, padx = 50, sticky=W)
            column += 1
        ...
        column = 0
        for word in games:
            Radiobutton(self, text=word, variable=self.game, value=word).grid(row=6, column=column, padx = 50, sticky=W)
            column += 1
        ...
        for word in fantasies:
            Radiobutton(self, text=word, variable=self.fantasy, value=word).grid(row=8, column=column, padx = 50, sticky=W)
            column += 1
        ...
        for word in holidays:
            Radiobutton(self, text=word, variable=self.holiday, value=word).grid(row=10, column=column, padx = 50, sticky=W)
            column += 1

        submit_bttn = Button(self, text="Click to See Your Result!", command=self.color)
        submit_bttn.grid(row=11, column=2, columnspan = 2)
        self.story_txt = Text(self, width=75, height=10, wrap=WORD)
        self.story_txt.grid(row=12, column=1, columnspan=4)
