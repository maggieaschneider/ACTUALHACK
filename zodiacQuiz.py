...
class spirit_animal(Frame):
    def __init__(self, master):
        super(spirit_animal, self).__init__(master)
        self.grid()
        self.create_widgets()

    def create_widgets(self):
        Label(self, text = "Answer these questions to find which spirit animal you are!").grid(row = 0, column = 1, columnspan = 2)
